...
for w in range(15,200,5):

    print("epoch = ",w)
    MeanIoU, IArea, OArea, Overlap, MeanCont = [], [], [], [], []
    root_p='/home/whq/HKUSTGZ/RVOS/MTTR-main/runs/2023-06-27-11:31/validation_outputs/epoch_'+str(w)+'/'
    root_gt='/home/whq/HKUSTGZ/RVOS/MTTR-main/miccai/valid/Annotations/'
